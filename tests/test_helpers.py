...
def create_minimal_sim_client() -> SpanPanelClient:
    """Create a minimal simulation client for basic testing."""
    return create_yaml_sim_client("minimal_config.yaml")


def create_behavior_sim_client() -> SpanPanelClient:
    """Create a simulation client for testing behavior patterns."""
    return create_yaml_sim_client("behavior_test_config.yaml")


def create_simple_sim_client() -> SpanPanelClient:
    """Create a simple simulation client for general testing."""
    return create_yaml_sim_client("simple_test_config.yaml")


def create_full_sim_client() -> SpanPanelClient:
    """Create a full 32-circuit simulation client."""
    return create_yaml_sim_client("simulation_config_32_circuit.yaml")
