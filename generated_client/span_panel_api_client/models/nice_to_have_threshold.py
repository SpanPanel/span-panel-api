...
class NiceToHaveThreshold(BaseModel):
    ...
    nice_to_have_threshold_low_soe: StateOfEnergy | None = None
    nice_to_have_threshold_high_soe: StateOfEnergy | None = None
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "nice_to_have_threshold_low_soe": (
                    StateOfEnergy.from_dict(obj["nice_to_have_threshold_low_soe"])
                    if obj.get("nice_to_have_threshold_low_soe") is not None
                    else None
                ),
                "nice_to_have_threshold_high_soe": (
                    StateOfEnergy.from_dict(obj["nice_to_have_threshold_high_soe"])
