    ...
    def make_instance(self, include_optional) -> PanelState:
        ...
        if include_optional:
            return PanelState(
                ...
                main_meter_energy = span_panel_api.models.main_meter_energy.MainMeterEnergy(
                    produced_energy_wh = 1.337,
                    consumed_energy_wh = 1.337, ),
                instant_grid_power_w = 1.337,
                feedthrough_power_w = 1.337,
                feedthrough_energy = span_panel_api.models.feedthrough_energy.FeedthroughEnergy(
                    produced_energy_wh = 1.337,
                    consumed_energy_wh = 1.337, ),
                ...
                current_run_config = '',
                branches = [
                    span_panel_api.models.branch.Branch(
                        id = 56,
                        relay_state = 'UNKNOWN',
